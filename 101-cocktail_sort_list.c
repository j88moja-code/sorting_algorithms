...
/**
 * swap_node_ahead - swaps a node in a listint_t linked list
...
/**
 * swap_node_behind - swaps a node in a listint_t linked
...
/**
 * cocktail_sort_list - sorts a listint_t linked list of integers in
